                ...
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers("/", "/index.html", "/barberia6.jpg", "/Logo.jpeg",
                                                                "/static", "/resources", "/Fondo.jpeg", "/BuzzCut.jpeg",
                                                                "/Ceradecabello.jpg", "/cortebarberia.jpeg",
                                                                "/Cremadeafeitar.jpg",
                                                                "/Cremaparaelcabello.jpg", "/Gelparaelcabello.jpg",
                                                                "/TaperFade.jpg",
                                                                "/Lowfadee.jpg", "/Mohicano.jpg", "/templates",
                                                                "/register",
                                                                "/style.css", "/public/**")
                                                .permitAll()

                                                // Rutas para administrador
                                                .requestMatchers("/admin/**", "/personas").hasRole("administrador")
                                ...
                                .formLogin(form -> form
                                                ...
                                                .defaultSuccessUrl("/index", true) // Redirigir a /index después de
                                                                                   // login exitoso
                                )
                                ...
                                .exceptionHandling(exception -> exception
                                                .accessDeniedPage("/Permisos")) // Página de acceso denegado
